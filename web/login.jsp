...
<head>
    ...
    <script language="javascript">
        ...
        function changeRandom() {
            ...
            //修改图片的地址
            $("#randomImg").attr("src","random.jpeg?time="+new Date().toLocaleString());
...
<div class="loginbody">
    ...
    <div class="loginbox loginbox2">
        ...
        <ul>
            <li><input name="empId" type="text" class="loginuser" value="mayun" onclick="JavaScript:this.value=''"/>
                <br/>
                ${error}
            </li>
            <li><input name="password" type="password" class="loginpwd" value="123456" onclick="JavaScript:this.value=''"/></li>
            <li class="yzm">
                <span><input name="verifyCode" type="text" value="验证码" onclick="JavaScript:this.value=''"/></span><cite><img
                  id="randomImg"  src="random.jpeg" alt="" onclick="changeRandom()"></cite>
            </li>
